          ...
          <div className="space-y-8">
            ...
            {clerkConfigured ? (
              ...
              <div className="rounded-3xl border border-border/80 bg-card-strong px-5 py-4 text-sm leading-7 text-muted-foreground">
                Auth-dependent routes stay protected, but this environment is currently running in public preview mode until the Clerk keys are added locally or in deployment config.
              </div>
            )}
          </div>
