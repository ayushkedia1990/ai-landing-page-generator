        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
          <ProjectIntakeForm
            ...
            initialValues={{
              ...
              outcomePromise: intakeDefaults.outcomePromise ?? "",
              uniqueAdvantage: intakeDefaults.uniqueAdvantage ?? "",
              primaryCta: intakeDefaults.primaryCta ?? "",
              ctaGoal: intakeDefaults.ctaGoal ?? "book-discovery-call",
              conversionFrameworks: intakeDefaults.conversionFrameworks ?? ["aida"],
              tone: intakeDefaults.tone ?? "",
              toneOfVoice:
                intakeDefaults.toneOfVoice ?? "professional-authoritative",
              styleDirection: intakeDefaults.styleDirection ?? "editorial",
              brandName: intakeDefaults.brandName ?? "",
              brandColors: intakeDefaults.brandColors ?? ["#2563eb"],
              fontFamily: intakeDefaults.fontFamily ?? "Inter",
              logoUrl: intakeDefaults.logoUrl ?? "",
              includeSections: intakeDefaults.includeSections ?? ["hero", "features", "faq", "final-cta"],
              stylePreset:
